...
/**
 * @brief Receive Control info from ESP8266 promiscuous mode.
 */
struct RxControl {
  signed rssi : 8;
  unsigned rate : 4;
...
/**
 * @brief Sniffer buffer structure for data packets.
 */
struct sniffer_buf {
...
/**
 * @brief Sniffer buffer structure for management packets.
 */
struct sniffer_buf2 {
  struct RxControl rx_ctrl;
...
/**
 * @brief 802.11 Frame Control Flags.
 */
...
// 802.11-2016.pdf, #670
/**
 * @brief 802.11 Frame Control field.
 */
...
/**
 * @brief Body of Deauthentication or Disassociation frame.
 */
...
/**
 * @brief Body of Beacon frame.
 */
struct
    ieee80211_beacon // https://mrncciew.com/2014/10/08/802-11-mgmt-beacon-frame/
{
...
/**
 * @brief 802.11 Management Frame Header.
 */
struct ieee80211_frame_header {
  ...
  //  Instead of using struct, using uint8_t to bypass extra byte bug causing
  //  issues with ssid_len
  // struct ieee80211_sequence_control sequence_control; //// making it 4
  // instead of 12 to bypass bug of extra one 8 causing issue with beacon
  uint16_t seq_ctrl;
  union {
